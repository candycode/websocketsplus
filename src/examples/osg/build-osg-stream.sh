...
TJ_LIB_DIR="/opt/libjpeg-turbo/lib64"; \
WS_INCLUDES="/usr/local/libwebsockets/include"; \
WS_LIB_DIR="/usr/local/libwebsockets/lib"; \
CC=g++; \
SOURCE_PATH=/home/ugo/projects/websocketsplus; \
OUT_PATH=/home/ugo/projects/websocketsplus/tmp-build; \
$CC -std=c++11  $SOURCE_PATH/src/examples/osg/osg-stream.cpp \
...
-losgText -lGL -lturbojpeg -lwebsockets -O3 -pthread -o $OUT_PATH/osg-stream.exe
